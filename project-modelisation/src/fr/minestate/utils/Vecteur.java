...
public class Vecteur {
	...
	public Vecteur normale(Point[] p) {
		...
		//Vecteur correspondant à AB
		Vecteur n1 = new Vecteur(p[1].getX()-p[0].getX(),p[1].getY()-p[0].getY(),p[1].getZ()-p[0].getZ());
		//Vecteur correspondant à AC
		Vecteur n2 = new Vecteur(p[2].getX()-p[0].getX(),p[2].getY()-p[0].getY(),p[2].getZ()-p[0].getZ());
		//Produit Vectoriel des 2 vecteurs précédents : obtention d'un vecteur normal à la face
		//On v�rifie que la cam�ra observe le bon c�t� de la face
